<?php
/*
 * Данный файл содержит веб-страницу, которая отображает информацию пользователю Web-отчеты
 */
include 'gamlib/DBworker.php';
...
if(!isset($_SESSION["farmname"]))
{
	if(isset($_POST["login"]) or isset($_POST["pass"]))
	{
		...
		$farm = ServFunc::GetUserFarm($_POST["login"], $_POST["pass"]);
		if($farm == "")
		{	
